...
export const Bio = () => {
  return (
    <ol className={s.list}>
      ...
      <li className={s.text}>* consectetur adipiscing elit, sed do eiusmod</li>
      ...
      <li className={s.text}>* voluptate velit esse cillum dolore eu fugiat</li>
      <li className={s.text}>* nulla pariatur. Excepteur sint occaecat </li>
      <li className={s.text}>* officia deserunt mollit anim id est laborum.</li>
      <li className={s.text}>*/</li>
      <li className={s.text}>/**</li>
      <li className={s.text}>* About me</li>
      <li className={s.text}>* I have 5 years of еxperience in web</li>
